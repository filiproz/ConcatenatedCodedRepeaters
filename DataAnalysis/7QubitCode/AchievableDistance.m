function [MaxDistanceMin, MaxDistance, MaxDistanceMax] = AchievableDistance(Data7QubitCode,RelError)
...
for i = 1:Lmax/Lfix
    ...
    for NMultiQubit = 1:MultiQubitStationsRange
        for Nall = NMultiQubit:NMultiQubit:AllStationsRange
            Zerr = (1+RelError)*Data7QubitCode(NMultiQubit, Nall,2);
            Xerr = (1+RelError)*Data7QubitCode(NMultiQubit, Nall,3);
