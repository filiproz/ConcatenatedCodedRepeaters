function out = Costfunction7QubitCode(Nall, NMultiQubit, Ltot, Zerr, Xerr)
% Normalised cost function for the [[7,1,3]]-code architecture
...
%Cost function
out =  (( 1/Lfix) * (4*(Nall-NMultiQubit) + 311*NMultiQubit) + 311/Ltot)/secret_key;