function [SecretKeyMinCostfunc,SecretKeyMinCostfuncOnlyMultiQubit] = SecretKeyForOptimisedCostFunctionOverStations(Data4QubitCode,MinNMultiQubit,MinNall,MinNOnlyMultiQubit)
...
for i = 1:Lmax/Lfix
    ...
    ZerrOnlyMultiQubit = Data4QubitCode(NOnlyMultiQubit, NOnlyMultiQubit, 2);
    XerrOnlyMultiQubit = Data4QubitCode(NOnlyMultiQubit, NOnlyMultiQubit, 3);
