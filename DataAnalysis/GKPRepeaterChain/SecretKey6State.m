function out = SecretKey6State(Nall, Ltot, Zerr, Xerr)
%This function calculates secret key fraction per optical mode for the
%architecture based on the [[4,1,2]]-code.
