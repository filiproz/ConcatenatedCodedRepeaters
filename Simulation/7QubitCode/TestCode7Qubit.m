...
[psucc,Zerr,Xerr] = Code7Qubit(1, 0, 0, 1, 1000);
...
t = 0.03;
[psucc,Zerr,Xerr] = Code7Qubit(0, 999999, 0, 1, 1000);
assert(all([psucc,Zerr,Xerr]<[0.25 + t,0.5 + t,0.5 + t]))
assert(all([psucc,Zerr,Xerr]>[0.25 - t,0.5 - t,0.5 - t]))
[psucc,Zerr,Xerr] = Code7Qubit(0, 999999, 0.11, 1, 1000);
assert(all([psucc,Zerr,Xerr]<[0.25 + t,0.5 + t,0.5 + t]))
assert(all([psucc,Zerr,Xerr]>[0.25 - t,0.5 - t,0.5 - t]))
...
[psucc,Zerr,Xerr] = Code7Qubit(1, 0.5, 0, 1, 1000);
pX = Xerr * (1-Zerr);
pZ = Zerr * (1-Xerr);
pY = Zerr * Xerr;
q = pX + pZ  + pY + sqrt(pX*pZ) + sqrt(pX*pY) + sqrt(pY*pZ);
assert(q>0.5)
[psucc,Zerr,Xerr] = Code7Qubit(1, 0.5, 0.11, 1, 1000);
pX = Xerr * (1-Zerr);
pZ = Zerr * (1-Xerr);
pY = Zerr * Xerr;
q = pX + pZ  + pY + sqrt(pX*pZ) + sqrt(pX*pY) + sqrt(pY*pZ);
